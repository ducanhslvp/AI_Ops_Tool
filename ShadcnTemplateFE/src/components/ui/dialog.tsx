  ...
  return (
    <DialogPortal data-slot='dialog-portal'>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'fixed top-[8svh] left-[50%] z-50 grid !max-h-[84svh] !w-[calc(100vw-2rem)] !max-w-[calc(100vw-2rem)] translate-x-[-50%] gap-4 overflow-y-auto rounded-lg border bg-background p-6 shadow-lg duration-200 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 sm:!w-[80vw] sm:!max-w-[80vw]',
          className
        )}
        {...props}
      >
